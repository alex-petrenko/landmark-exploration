class Trajectory:
    ...
    def add(self, obs, action, mode, target_idx, curr_landmark_idx, is_landmark):
        self.obs.append(obs)
    ...
    def add_frame(self, tr, i):
        self.add(tr.obs[i], tr.actions[i], tr.modes[i], tr.target_idx[i], tr.curr_landmark_idx[i], tr.is_landmark[i])
