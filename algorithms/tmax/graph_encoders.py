...
class NeighborhoodEncoderRNN(Encoder):
    ...
    def __init__(self, neighbors, num_neighbors, params, name):
        ...
        with tf.variable_scope(self.name):
            ...
            neighbors = tf.reshape(neighbors, [-1, params.graph_encoder_rnn_size] + obs_shape)

            cell = tf.nn.rnn_cell.GRUCell(params.encoder_rnn_size)
            ...
            self.encoded_neighborhoods = tf.layers.dense(last_states, params.encoder_rnn_size, activation=tf.nn.relu)
